    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./">Trung Lê</a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                   ...
                   <!--  <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fas fa-plus-square"></i><a href="tables-basic.html">Create Category</a></li>
                    ...
                    <li class="menu-item-has-children ">
                        <a href="{{route('brand.index')}}" class="dropdown-toggle" ><i class="fas fa-list mr-5"></i>Brands</a>
                    </li>
                     <li class="menu-item-has-children ">
                        <a href="{{route('size.index')}}" class="dropdown-toggle" ><i class="fas fa-list mr-5"></i>Size</a>
                    </li>
                    <li class="menu-item-has-children ">
                        <a href="{{route('promotion.index')}}" class="dropdown-toggle" ><i class="fas fa-list mr-5"></i>Promotions</a>
                    </li>
                    <li class="menu-item-has-children ">
                    ...
                    <!-- <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-box"></i>Products</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fas fa-plus-square"></i><a href="tables-basic.html">Create Product</a></li>
                            <li><i class="fas fa-list"></i><a href="tables-data.html">List Products</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
